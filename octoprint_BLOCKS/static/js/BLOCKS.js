...
$(function () {
    function BlocksViewModel(parameters) {
        ...
        self.onEventConnecting = function () {
            ...
            $("#blocksWrapper > .container-fluid ").addClass(
                "scale-up-ver-top"
            );
            $("#PrinterImg")
                .removeClass("scale-down-center")
        ...
        self.onDataUpdaterPluginMessage = function (plugin, data) {
            try {
                ...
                if (data.message == "Blocks Pro S30") {
                    self.setStorage(
                        "Machine_Type",
                        "<img src='./plugin/BLOCKS/static/img/Blocks_PS30.png'>"
                    );
                } else if (data.message == "Blocks zero") {
                    self.setStorage(
                        "Machine_Type",
                        "<img src='./plugin/BLOCKS/static/img/Blocks_zero.png'>"
                    );
                } else if (data.message == "Blocks One MKII") {
                    self.setStorage(
                        "Machine_Type",
                        "<img src='./plugin/BLOCKS/static/img/Blocks_mkii2.png'>"
                    );
                } else {
        ...
        self._buildGrid = function (settingsPlugin) {
            try {
                // Create a 2x3 grid
                $("div.BLOCKSMainContainer > div.row")
                    .removeClass("row")
                    .addClass("row-fluid")
                    .addClass("TopRow");
                //add another row after the TopRow
                $('<div class= "row-fluid BotRow" ></div>').insertBefore(
                    "div.footer"
                );
                //Id the two rows
                $("div.BLOCKSMainContainer > div.row-fluid.TopRow").attr(
                    "id",
                    "BLOCKSRowTop"
                );
                $("div.BLOCKSMainContainer > div.row-fluid.BotRow").attr(
                    "id",
                    "BLOCKSRowBot"
                );
                // All that is left to do is just create my collumns.
                $("#BLOCKSRowTop").append(
                    '<div class="col-4-md BLOCKCol1" data-theme="light" id="BTC1"></div>'
                );
                $("#BLOCKSRowTop").append(
                    '<div class="col-4-md BLOCKCol2" data-theme="light" id="BTC2"></div>'
                );
                $("#BLOCKSRowTop").append(
                    '<div class="col-4-md BLOCKCol3" data-theme="light" id="BTC3"></div>'
                );
                $("#BLOCKSRowBot").append(
                    '<div class="col-4-md BLOCKCol1" data-theme="light" id="BBC1"></div>'
                );
                $("#BLOCKSRowBot").append(
                    '<div class="col-4-md BLOCKCol2" data-theme="light" id="BBC2"></div>'
                );
                $("#BLOCKSRowBot").append(
                    '<div class="col-4-md BLOCKCol3" data-theme="light" id="BBC3"></div>'
                );
            } catch (e) {
                self.logToConsole(e);
            }
        ...
        self._bindWrappers = function (settingsPlugin) {
            try {
                $("#sidebar_plugin_firmware_check_info_wrapper").appendTo(
                    $("#BTC1")
                );
                $("#sidebar_plugin_firmware_check_warning_wrapper").appendTo(
                    $("#BTC1")
                );
                ...
                $("#LightDarkSwitchWrapper").appendTo(
        ...
        self._set_NewAppearence = function () {
            try {
                ...
                $(".navbar-fixed-top > .navbar-inner").css({
                    "-webkit-box-shadow": "unset",
                    "box-shadow": "unset",
                });
        ...
        self._set_fluidLayout = function (enabled) {
            try {
                $("#navbar > div.navbar-inner > div:first")
                    .removeClass("container")
                    .addClass("container-fluid")
                    .removeAttr("style", "");
                $("div.BLOCKSMainContainer")
                    .removeClass("container")
                    .addClass("container-fluid");
            } catch (e) {
                self.logToConsole(e);
        ...
        self._set_blocksFooterInfo = function (enable) {
            ...
            try {
                $("#footer_links").prepend(
                    '<li><a href="https://www.blockstec.com/" id="blocks_link" target="_blank" rel="noreferrer noopener"> <img src="./plugin/BLOCKS/static/img/Blocks_Logo.png"> </a></li>'
                );
            } catch (e) {
                self.logToConsole(e);
            }
        ...
        self._add_subAttribute_data_theme = function () {
            try {
                ...
                $("body").attr("data-theme", "light");
                $("#navbar > .navbar-inner > .container-fluid").attr(
                    "data-theme",
                    "light"
                );
        ...
        self.set_blocksWrapper = function (settingsPlugin) {
            try {
                ...
                $("#sidebar_plugin_action_command_notification").prepend(
                    '<div class="container-fluid heading"><i class ="fa fa-bell"></i> Notifications </div>'
                );
            } catch (e) {
                self.logToConsole(e);
            }
        ...
        self._correctFilesWrapper = function (settingsPlugin) {
            try {
                ...
                ).wrapAll('<div id="files_triggers"></div>');
        ...
        self.set_TemperatureWrapper = function (settingsPlugin) {
            try {
                $("#temp").wrap(
                    '<div id="temp_wrapper" class="container-fluid" data-bind="visible: loginState.hasAnyPermissionKo(access.permissions.STATUS, access.permissions.CONTROL)"></div>'
                );
                $("#temp").removeClass("tab-pane").addClass("body");
                $(
                    '<a class="container-fluid heading" data-target = "#temperature" ></a>'
                ).insertBefore("#temp");
                $("#temp").wrapInner(
                    '<div class="container-fluid accordion-inner" ></div>'
                );
                $("#temp_wrapper > a").wrap(
                    '<div class="container-fluid heading" ></div>'
                );
                $("#temp_wrapper > div > a").append(
                    '<i class="fas icon-black fa-thermometer-quarter"></i>'
                );
